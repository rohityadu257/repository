...
<div id="wrapper">
	...
	<div style="border:4px; color: red;padding:20px;font-size:20px ;align :center"> 
		...
		<tbody>
			<c:forEach items="${students}" var="student">
				<tr>
					...
					<td><a href="ShowFormForupdate?Id=${student.id}"> Update </a>
	...
	<!--<button align= "centre" href = "ShowFormForAdd"  >Register new Student</button>-->
</body>
</html>